...
export const ContactSection = () => {
  return (
    <section id="contact" className="bg-gradient-to-b from-purple-500 to-teal-300 h-screen">
      ...
      <div className="flex justify-center items-center my-auto h-5/6 shadow-lg">
        <div className="flex flex-col justify-center items-center bg-white w-5/6 md:w-fit h-fit rounded-lg p-6">
          <form className="">
            ...
            <textarea className="w-full h-16 shadow-md placeholder:text-black focus:ring-16 focus:outline-none focus:ring-4 focus:rounded-md focus:ring-purple-300 placeholder:pl-4 placeholder:pt-2 focus:bg-white hover:bg-white rounded-md" placeholder="Message">
            </textarea>
            <div className="flex justify-center items-center text-center">
              <button className="pt-4 p-4 rounded-md shadow-lg">Submit</button>
            </div>
          </form>
        </div>
      </div>
